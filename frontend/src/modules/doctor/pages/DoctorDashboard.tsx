                    ...
                    {!user?.isProfileComplete ? (
                        ...
                        <section className={styles.statusPanel}>
                            ...
                            <p className={styles.sub}>
                                Your account is active and ready. You can now manage patients, schedules, and
                                consultations from your dashboard.
                            </p>
                        </section>
                    ) : (
                        <section className={styles.statusPanel}>
                            ...
                            <p className={styles.sub}>
                                We are reviewing your profile, medical council registration, and uploaded documents.
                                Once approved, your full doctor dashboard will be unlocked.
                            </p>
                            <div className={styles.infoGrid}>
                                ...
                                <div className={styles.infoCard}>
                                    ...
                                    <p>
                                        You will be able to access patients and appointments after verification is
                                        complete.
                                    </p>
                                </div>
                            </div>
